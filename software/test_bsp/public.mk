...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../DE2_115_NIOS_HOST_MOUSE_VGA.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8000070
SOPC_SYSID_FLAG += --sidp=0x8000070
ELF_PATCH_FLAG  += --sidp 0x8000070

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1681825803
SOPC_SYSID_FLAG += --timestamp=1681825803
ELF_PATCH_FLAG  += --timestamp 1681825803
