...
module DE2_115_SOPC_mm_interconnect_1 (
	...
	wire  [21:0] seg7_avalon_slave_agent_m0_address;                                      // seg7_avalon_slave_agent:m0_address -> seg7_avalon_slave_translator:uav_address
	...
	wire  [96:0] seg7_avalon_slave_agent_rf_source_data;                                  // seg7_avalon_slave_agent:rf_source_data -> seg7_avalon_slave_agent_rsp_fifo:in_data
	...
	wire  [96:0] seg7_avalon_slave_agent_rsp_fifo_out_data;                               // seg7_avalon_slave_agent_rsp_fifo:out_data -> seg7_avalon_slave_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_src_data;                                                        // cmd_mux:src_data -> seg7_avalon_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                       // seg7_avalon_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [6:0] cmd_mux_src_channel;                                                     // cmd_mux:src_channel -> seg7_avalon_slave_agent:cp_channel
	...
	wire  [96:0] lcd_control_slave_agent_rf_source_data;                                  // lcd_control_slave_agent:rf_source_data -> lcd_control_slave_agent_rsp_fifo:in_data
	...
	wire  [96:0] lcd_control_slave_agent_rsp_fifo_out_data;                               // lcd_control_slave_agent_rsp_fifo:out_data -> lcd_control_slave_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_002_src_data;                                                    // cmd_mux_002:src_data -> lcd_control_slave_agent:cp_data
	...
	wire  [21:0] key_s1_agent_m0_address;                                                 // key_s1_agent:m0_address -> key_s1_translator:uav_address
	...
	wire  [96:0] key_s1_agent_rf_source_data;                                             // key_s1_agent:rf_source_data -> key_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] key_s1_agent_rsp_fifo_out_data;                                          // key_s1_agent_rsp_fifo:out_data -> key_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_003_src_data;                                                    // cmd_mux_003:src_data -> key_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                   // key_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [6:0] cmd_mux_003_src_channel;                                                 // cmd_mux_003:src_channel -> key_s1_agent:cp_channel
	...
	wire  [21:0] sw_s1_agent_m0_address;                                                  // sw_s1_agent:m0_address -> sw_s1_translator:uav_address
	...
	wire   [6:0] cmd_mux_004_src_channel;                                                 // cmd_mux_004:src_channel -> sw_s1_agent:cp_channel
	...
	wire  [21:0] ledg_s1_agent_m0_address;                                                // ledg_s1_agent:m0_address -> ledg_s1_translator:uav_address
	...
	wire  [96:0] ledg_s1_agent_rf_source_data;                                            // ledg_s1_agent:rf_source_data -> ledg_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] ledg_s1_agent_rsp_fifo_out_data;                                         // ledg_s1_agent_rsp_fifo:out_data -> ledg_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_005_src_data;                                                    // cmd_mux_005:src_data -> ledg_s1_agent:cp_data
	...
	wire  [21:0] ledr_s1_agent_m0_address;                                                // ledr_s1_agent:m0_address -> ledr_s1_translator:uav_address
	...
	wire  [96:0] ledr_s1_agent_rf_source_data;                                            // ledr_s1_agent:rf_source_data -> ledr_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] ledr_s1_agent_rsp_fifo_out_data;                                         // ledr_s1_agent_rsp_fifo:out_data -> ledr_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_006_src_data;                                                    // cmd_mux_006:src_data -> ledr_s1_agent:cp_data
	...
	wire  [95:0] clock_crossing_io_m0_agent_cp_data;                                      // clock_crossing_io_m0_agent:cp_data -> router:sink_data
	...
	wire  [95:0] seg7_avalon_slave_agent_rp_data;                                         // seg7_avalon_slave_agent:rp_data -> router_001:sink_data
	...
	wire  [95:0] router_001_src_data;                                                     // router_001:src_data -> rsp_demux:sink_data
	...
	wire  [95:0] sysid_control_slave_agent_rp_data;                                       // sysid_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [95:0] router_002_src_data;                                                     // router_002:src_data -> rsp_demux_001:sink_data
	...
	wire  [95:0] lcd_control_slave_agent_rp_data;                                         // lcd_control_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [95:0] router_003_src_data;                                                     // router_003:src_data -> rsp_demux_002:sink_data
	...
	wire         key_s1_agent_rp_valid;                                                   // key_s1_agent:rp_valid -> router_004:sink_valid
	wire  [95:0] key_s1_agent_rp_data;                                                    // key_s1_agent:rp_data -> router_004:sink_data
	wire         key_s1_agent_rp_ready;                                                   // router_004:sink_ready -> key_s1_agent:rp_ready
	wire         key_s1_agent_rp_startofpacket;                                           // key_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         key_s1_agent_rp_endofpacket;                                             // key_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	wire         router_004_src_valid;                                                    // router_004:src_valid -> rsp_demux_003:sink_valid
	wire  [95:0] router_004_src_data;                                                     // router_004:src_data -> rsp_demux_003:sink_data
	...
	wire  [95:0] sw_s1_agent_rp_data;                                                     // sw_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [95:0] router_005_src_data;                                                     // router_005:src_data -> rsp_demux_004:sink_data
	...
	wire  [95:0] ledg_s1_agent_rp_data;                                                   // ledg_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [95:0] router_006_src_data;                                                     // router_006:src_data -> rsp_demux_005:sink_data
	...
	wire  [95:0] ledr_s1_agent_rp_data;                                                   // ledr_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [95:0] router_007_src_data;                                                     // router_007:src_data -> rsp_demux_006:sink_data
	...
	wire  [95:0] router_src_data;                                                         // router:src_data -> clock_crossing_io_m0_limiter:cmd_sink_data
	wire         router_src_ready;                                                        // clock_crossing_io_m0_limiter:cmd_sink_ready -> router:src_ready
	wire   [6:0] router_src_channel;                                                      // router:src_channel -> clock_crossing_io_m0_limiter:cmd_sink_channel
	...
	wire  [95:0] clock_crossing_io_m0_limiter_cmd_src_data;                               // clock_crossing_io_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         clock_crossing_io_m0_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> clock_crossing_io_m0_limiter:cmd_src_ready
	wire   [6:0] clock_crossing_io_m0_limiter_cmd_src_channel;                            // clock_crossing_io_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [95:0] rsp_mux_src_data;                                                        // rsp_mux:src_data -> clock_crossing_io_m0_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                       // clock_crossing_io_m0_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [6:0] rsp_mux_src_channel;                                                     // rsp_mux:src_channel -> clock_crossing_io_m0_limiter:rsp_sink_channel
	...
	wire  [95:0] clock_crossing_io_m0_limiter_rsp_src_data;                               // clock_crossing_io_m0_limiter:rsp_src_data -> clock_crossing_io_m0_agent:rp_data
	...
	wire   [6:0] clock_crossing_io_m0_limiter_rsp_src_channel;                            // clock_crossing_io_m0_limiter:rsp_src_channel -> clock_crossing_io_m0_agent:rp_channel
	...
	wire   [6:0] clock_crossing_io_m0_limiter_cmd_valid_data;                             // clock_crossing_io_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	wire         ledg_s1_agent_rdata_fifo_src_valid;                                      // ledg_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] ledg_s1_agent_rdata_fifo_src_data;                                       // ledg_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         ledg_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_005:in_0_ready -> ledg_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                       // avalon_st_adapter_005:out_0_valid -> ledg_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                        // avalon_st_adapter_005:out_0_data -> ledg_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                       // ledg_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                       // avalon_st_adapter_005:out_0_error -> ledg_s1_agent:rdata_fifo_sink_error
	...
	DE2_115_SOPC_mm_interconnect_1_router_001 router_005 (
	...
	DE2_115_SOPC_mm_interconnect_1_router_001 router_006 (
	...
	DE2_115_SOPC_mm_interconnect_1_router_001 router_007 (
	...
	DE2_115_SOPC_mm_interconnect_1_cmd_mux cmd_mux_004 (
		.clk                 (pll_c2_clk),                                             //       clk.clk
		.reset               (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE2_115_SOPC_mm_interconnect_1_cmd_mux cmd_mux_005 (
		.clk                 (pll_c2_clk),                                             //       clk.clk
		.reset               (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE2_115_SOPC_mm_interconnect_1_cmd_mux cmd_mux_006 (
		.clk                 (pll_c2_clk),                                             //       clk.clk
		.reset               (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE2_115_SOPC_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (pll_c2_clk),                                             //       clk.clk
		.reset              (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE2_115_SOPC_mm_interconnect_1_rsp_demux rsp_demux_003 (
		.clk                (pll_c2_clk),                                             //       clk.clk
		.reset              (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE2_115_SOPC_mm_interconnect_1_rsp_demux rsp_demux_004 (
		.clk                (pll_c2_clk),                                             //       clk.clk
		.reset              (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE2_115_SOPC_mm_interconnect_1_rsp_demux rsp_demux_005 (
		.clk                (pll_c2_clk),                                             //       clk.clk
		.reset              (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE2_115_SOPC_mm_interconnect_1_rsp_demux rsp_demux_006 (
		.clk                (pll_c2_clk),                                             //       clk.clk
		.reset              (clock_crossing_io_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
